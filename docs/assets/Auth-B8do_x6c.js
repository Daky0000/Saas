import{j as e}from"./vendor-editor-BzX8FkT3.js";import{r as t}from"./vendor-charts-Ch11R6_Y.js";import{A as h,O as F}from"./index-Cf_M1ZQT.js";const I=async n=>{const s=await n.text().catch(()=>"");try{return{data:JSON.parse(s),rawText:s}}catch{return{data:null,rawText:s}}},_="",ee=`
...
`,ae=["","Weak","Fair","Good","Strong"];function te(n){if(!n)return 0;let s=0;return n.length>=6&&s++,n.length>=10&&s++,/[A-Z]/.test(n)&&/[a-z]/.test(n)&&s++,/[0-9]/.test(n)&&/[^A-Za-z0-9]/.test(n)&&s++,Math.min(4,s)}function B({color:n="#fff"}){return e.jsx("svg",{viewBox:"0 0 44 44",fill:"none",children:e.jsxs("g",{stroke:n,strokeWidth:"5.5",strokeLinecap:"round",children:[e.jsx("line",{x1:"22",y1:"6",x2:"22",y2:"38"}),e.jsx("line",{x1:"8.5",y1:"13",x2:"35.5",y2:"31"}),e.jsx("line",{x1:"35.5",y1:"13",x2:"8.5",y2:"31"})]})})}function $({open:n}){return n?e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",children:e.jsx("path",{d:"M2 2 L14 14 M5.5 5.5 C4 6.5 2.5 8 2.5 8 C2.5 8 5 12 8 12 C9 12 9.9 11.7 10.7 11.2 M11 6 C12.5 7 13.5 8 13.5 8 C13.5 8 11 12 8 12",stroke:"currentColor",strokeLinecap:"round"})}):e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",children:[e.jsx("path",{d:"M2.5 8 C2.5 8 5 4 8 4 C11 4 13.5 8 13.5 8 C13.5 8 11 12 8 12 C5 12 2.5 8 2.5 8 Z",stroke:"currentColor"}),e.jsx("circle",{cx:"8",cy:"8",r:"2",stroke:"currentColor"})]})}function z(){return e.jsx("svg",{width:"9",height:"9",viewBox:"0 0 9 9",fill:"none",children:e.jsx("path",{d:"M1.5 4.5 L3.5 6.5 L7.5 2.5",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})}function re({mode:n}){const s={signup:{eb:"Welcome to Daky",h:e.jsxs(e.Fragment,{children:["Get access to your ",e.jsx("em",{children:"AI content strategist"})," — always on, always learning."]})},login:{eb:"Welcome back",h:e.jsxs(e.Fragment,{children:["Pick up where you left off — your ",e.jsx("em",{children:"content brain"})," kept everything warm."]})},forgot:{eb:"Forgot password",h:e.jsxs(e.Fragment,{children:["Enter your email and we'll send you a ",e.jsx("em",{children:"secure reset link"}),"."]})}}[n];return e.jsxs("div",{className:"da-visual",children:[e.jsx("div",{className:"da-vp-mark",children:e.jsx(B,{})}),e.jsxs("div",{className:"da-floats",children:[e.jsxs("div",{className:"da-float da-f1",children:[e.jsxs("div",{className:"da-fh",children:[e.jsx("span",{className:"da-pdot",style:{background:"linear-gradient(135deg,#FEDA77,#F58529,#DD2A7B)"},children:"IG"}),"Instagram · scheduled"]}),e.jsx("div",{className:"da-fb",children:`"Q2 just dropped — here's what 50K creators learned about hooks…"`}),e.jsxs("div",{className:"da-fm",children:[e.jsx("span",{className:"da-pill",children:"9:14 AM"}),e.jsx("span",{className:"da-pill",children:"+3 tags"})]})]}),e.jsxs("div",{className:"da-float da-f2",children:[e.jsxs("div",{className:"da-fh",children:[e.jsx("span",{className:"da-pdot",style:{background:"#0A66C2"},children:"in"}),"LinkedIn · draft"]}),e.jsx("div",{className:"da-fb",children:'"We spent 6 months testing pricing pages…"'}),e.jsx("div",{className:"da-fm",children:e.jsx("span",{className:"da-pill",children:"Tue 7:30"})})]})]}),e.jsxs("div",{className:"da-vp-foot",children:[e.jsx("div",{className:"da-vp-eyebrow",children:s.eb}),e.jsx("h2",{className:"da-vp-h",children:s.h}),e.jsxs("div",{className:"da-vp-meta",children:[e.jsxs("span",{children:[e.jsx("span",{className:"da-vp-check",children:e.jsx(z,{})})," 6 platforms"]}),e.jsxs("span",{children:[e.jsx("span",{className:"da-vp-check",children:e.jsx(z,{})})," AI that learns"]}),e.jsxs("span",{children:[e.jsx("span",{className:"da-vp-check",children:e.jsx(z,{})})," Free forever"]})]})]})]})}function ue({onLogin:n}){const[s,D]=t.useState("login"),[u,x]=t.useState(!1),[m,d]=t.useState(null),[j,v]=t.useState(null),[w,A]=t.useState(""),[f,J]=t.useState([]),[ne,se]=t.useState(!1),[ie,oe]=t.useState(!1),[de,le]=t.useState(null);t.useRef(null),t.useRef(!1);const[k,V]=t.useState(""),[N,G]=t.useState(""),[M,H]=t.useState(!1),[E,R]=t.useState(!1),[C,W]=t.useState(""),[b,O]=t.useState(""),[p,Y]=t.useState(""),[T,U]=t.useState(!1),[L,Z]=t.useState(!0),S=t.useMemo(()=>te(p),[p]),g=a=>{D(a),d(null),v(null)};t.useEffect(()=>{},[]),t.useEffect(()=>{fetch(`${h}/api/auth/providers`).then(a=>a.json()).then(a=>{a.success&&J(a.providers)}).catch(()=>{})},[]),t.useEffect(()=>{const a=new URLSearchParams(window.location.search),l=a.get("auth_token"),c=a.get("auth_error");if(l){window.history.replaceState({},"",window.location.pathname);try{const i=JSON.parse(atob(l.split(".")[1]));localStorage.setItem("auth_token",l),n(F({id:i.userId,email:i.email,name:i.email.split("@")[0],username:null,phone:null,country:null,role:i.role==="admin"?"admin":"user"}))}catch{d("Social login failed — invalid token")}}else c&&(window.history.replaceState({},"",window.location.pathname),d(decodeURIComponent(c)))},[n]);const y=a=>{window.location.href=`${h}/api/auth/${a}/start`},K=async a=>{var l,c;if(a.preventDefault(),d(null),!k.trim()){d("Please enter your email or username.");return}if(!N.trim()){d("Please enter your password.");return}x(!0);try{const i=await fetch(`${h}/api/auth/login`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({identifier:k.trim(),password:N})}),{data:r,rawText:o}=await I(i);if(!r)throw new Error(`Server error (${i.status}): ${o.slice(0,200)||"empty"}`);if(!i.ok||!r.success||!r.token||!((l=r.user)!=null&&l.id)||!((c=r.user)!=null&&c.email))throw new Error(r.error||"Authentication failed");localStorage.setItem("auth_token",r.token),E&&localStorage.setItem("remember_login",k.trim()),n(F({id:r.user.id,email:r.user.email,name:r.user.name??null,username:r.user.username??null,phone:r.user.phone??null,country:r.user.country??null,role:r.user.role==="admin"?"admin":"user"}))}catch(i){const r=i instanceof Error?i.message:"Unable to authenticate",o=r==="Invalid credentials"?"Email or password is incorrect. Please try again.":r;d(i instanceof TypeError?`Backend unavailable (${h})`:o)}finally{x(!1)}},Q=async a=>{var l,c;if(a.preventDefault(),d(null),!C.trim()||!b.trim()||!p.trim()){d("Please fill in all fields.");return}if(!b.includes("@")){d("Please enter a valid email address.");return}if(p.length<6){d("Password must be at least 6 characters.");return}if(!L){d("Please accept the Terms and Privacy Policy to continue.");return}x(!0);try{const i=b.split("@")[0].toLowerCase().replace(/[^a-z0-9_]/g,"_"),r=await fetch(`${h}/api/auth/register`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:C.trim(),username:i,email:b.trim(),password:p})}),{data:o,rawText:q}=await I(r);if(!o)throw new Error(`Server error (${r.status}): ${q.slice(0,200)||"empty"}`);if(!r.ok||!o.success||!o.token||!((l=o.user)!=null&&l.id)||!((c=o.user)!=null&&c.email))throw new Error(o.error||"Account creation failed");localStorage.setItem("auth_token",o.token),n(F({id:o.user.id,email:o.user.email,name:o.user.name??null,username:o.user.username??null,phone:o.user.phone??null,country:o.user.country??null,role:"user"}))}catch(i){d(i instanceof TypeError?`Backend unavailable (${h})`:i instanceof Error?i.message:"Unable to create account")}finally{x(!1)}},X=async a=>{if(a.preventDefault(),d(null),v(null),!w.trim()||!w.includes("@")){d("Please enter a valid email address.");return}x(!0);try{await fetch(`${h}/api/auth/forgot-password`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:w.trim()})}),v("If that email exists, a reset link has been sent. Check your inbox (and spam folder)."),A("")}catch{v("If that email exists, a reset link has been sent.")}finally{x(!1)}},P=f.length>0||!1;return e.jsxs("div",{className:"da-root",children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:ee}}),e.jsxs("div",{className:"da-page",children:[e.jsxs("div",{className:"da-bg-orbs",children:[e.jsx("div",{className:"da-o1"}),e.jsx("div",{className:"da-o2"})]}),e.jsxs("div",{className:"da-card",children:[e.jsx(re,{mode:s}),e.jsxs("div",{className:"da-form-pane",children:[e.jsxs("button",{className:"da-back",onClick:()=>window.history.back(),children:[e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 12 12",fill:"none",children:e.jsx("path",{d:"M8 2 L4 6 L8 10",stroke:"currentColor",strokeLinecap:"round",strokeLinejoin:"round"})}),"Back to home"]}),s!=="forgot"&&e.jsxs("div",{className:"da-tabs",children:[e.jsx("button",{className:`da-tab ${s==="signup"?"active":""}`,onClick:()=>g("signup"),children:"Create account"}),e.jsx("button",{className:`da-tab ${s==="login"?"active":""}`,onClick:()=>g("login"),children:"Sign in"})]}),s==="signup"&&e.jsxs("form",{className:"da-form-state",onSubmit:Q,noValidate:!0,children:[e.jsx("div",{style:{display:"flex",alignItems:"center",gap:10,marginBottom:4},children:e.jsx("span",{className:"da-mark",children:e.jsx(B,{color:"var(--da-accent)"})})}),e.jsx("h1",{className:"da-form-h",children:"Create an account"}),e.jsx("p",{className:"da-form-sub",style:{marginTop:8},children:"Generate, schedule, and learn from a month of content — across six channels, in one place."}),m&&e.jsxs("div",{className:"da-err",children:[e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",children:[e.jsx("circle",{cx:"7",cy:"7",r:"6",stroke:"currentColor"}),e.jsx("path",{d:"M7 4 V8 M7 10 V10.1",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round"})]}),m]}),e.jsxs("div",{className:"da-field-group",style:{marginTop:20},children:[e.jsxs("div",{className:"da-field",children:[e.jsx("label",{htmlFor:"su-name",children:"Your name"}),e.jsx("div",{className:"da-input-wrap",children:e.jsx("input",{id:"su-name",type:"text",placeholder:"Alex Jordan",value:C,onChange:a=>W(a.target.value),autoComplete:"name"})})]}),e.jsxs("div",{className:"da-field",children:[e.jsx("label",{htmlFor:"su-email",children:"Your email"}),e.jsx("div",{className:"da-input-wrap",children:e.jsx("input",{id:"su-email",type:"email",placeholder:"you@company.com",value:b,onChange:a=>O(a.target.value),autoComplete:"email"})})]}),e.jsxs("div",{className:"da-field",children:[e.jsx("label",{htmlFor:"su-password",children:"Password"}),e.jsxs("div",{className:"da-input-wrap has-icon",children:[e.jsx("input",{id:"su-password",type:T?"text":"password",placeholder:"At least 6 characters",value:p,onChange:a=>Y(a.target.value),autoComplete:"new-password"}),e.jsx("button",{type:"button",className:"da-eye-btn",onClick:()=>U(a=>!a),children:e.jsx($,{open:T})})]}),p&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"da-pwd-bars",children:[1,2,3,4].map(a=>e.jsx("span",{className:`da-pwd-bar ${S>=a?`s${S}`:""}`},a))}),e.jsxs("div",{className:"da-pwd-hint",children:[ae[S]," · 8+ chars with number & symbol = strong"]})]})]}),e.jsxs("label",{className:"da-checkbox",style:{marginTop:2},children:[e.jsx("input",{type:"checkbox",checked:L,onChange:a=>Z(a.target.checked)}),e.jsx("span",{className:"da-box",children:e.jsx("svg",{width:"10",height:"10",viewBox:"0 0 10 10",children:e.jsx("path",{d:"M2 5 L4 7 L8 3",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round",fill:"none"})})}),e.jsxs("span",{children:["I agree to the ",e.jsx("a",{href:"/terms",className:"da-link da-link-accent",children:"Terms"})," and ",e.jsx("a",{href:"/privacy",className:"da-link da-link-accent",children:"Privacy Policy"})]})]}),e.jsx("button",{type:"submit",className:"da-submit",disabled:u,style:{marginTop:4},children:u?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"da-spinner"})," Creating workspace…"]}):e.jsxs(e.Fragment,{children:["Get started ",e.jsx("span",{className:"da-arrow",children:"→"})]})})]}),P&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"da-divider",style:{marginTop:20},children:"or continue with"}),e.jsxs("div",{className:"da-oauth-row",style:{marginTop:12},children:[f.filter(a=>a.provider==="google").length>0&&e.jsxs("button",{type:"button",className:"da-oauth-btn",onClick:()=>y("google"),children:[e.jsxs("svg",{viewBox:"0 0 18 18",fill:"none",children:[e.jsx("path",{d:"M17.64 9.2c0-.64-.06-1.25-.16-1.84H9v3.49h4.84a4.14 4.14 0 0 1-1.8 2.72v2.26h2.91c1.7-1.57 2.69-3.88 2.69-6.63z",fill:"#4285F4"}),e.jsx("path",{d:"M9 18c2.43 0 4.47-.81 5.96-2.18l-2.91-2.26c-.81.54-1.84.86-3.05.86-2.34 0-4.32-1.58-5.03-3.71H.99v2.33A9 9 0 0 0 9 18z",fill:"#34A853"}),e.jsx("path",{d:"M3.97 10.71A5.41 5.41 0 0 1 3.68 9c0-.6.1-1.17.29-1.71V4.96H.99A9 9 0 0 0 0 9c0 1.45.35 2.83.99 4.04l2.98-2.33z",fill:"#FBBC05"}),e.jsx("path",{d:"M9 3.58c1.32 0 2.5.45 3.44 1.35l2.58-2.58A8.97 8.97 0 0 0 9 0 9 9 0 0 0 .99 4.96l2.98 2.33C4.68 5.16 6.66 3.58 9 3.58z",fill:"#EA4335"})]}),"Google"]}),f.filter(a=>a.provider==="github").length>0&&e.jsxs("button",{type:"button",className:"da-oauth-btn",onClick:()=>y("github"),children:[e.jsx("svg",{viewBox:"0 0 14 14",fill:"currentColor",children:e.jsx("path",{d:"M7 0a7 7 0 0 0-2.21 13.64c.35.06.48-.15.48-.34v-1.2c-1.95.42-2.36-.94-2.36-.94-.32-.81-.78-1.03-.78-1.03-.64-.43.05-.43.05-.43.7.05 1.07.72 1.07.72.62 1.07 1.64.76 2.04.58.06-.45.24-.76.44-.94-1.56-.18-3.2-.78-3.2-3.47 0-.77.27-1.4.72-1.89-.07-.18-.31-.9.07-1.88 0 0 .59-.19 1.93.72A6.7 6.7 0 0 1 7 3.36c.6 0 1.2.08 1.76.24 1.34-.91 1.93-.72 1.93-.72.38.98.14 1.7.07 1.88.45.49.71 1.12.71 1.89 0 2.7-1.65 3.29-3.22 3.46.25.22.48.65.48 1.32v1.96c0 .19.13.41.49.34A7 7 0 0 0 7 0z"})}),"GitHub"]}),_]})]}),e.jsxs("div",{className:"da-switch",style:{marginTop:20},children:["Already have an account?"," ",e.jsx("button",{type:"button",onClick:()=>g("login"),children:"Sign in"})]})]}),s==="login"&&e.jsxs("form",{className:"da-form-state",onSubmit:K,noValidate:!0,children:[e.jsx("div",{style:{display:"flex",alignItems:"center",gap:10,marginBottom:4},children:e.jsx("span",{className:"da-mark",children:e.jsx(B,{color:"var(--da-accent)"})})}),e.jsx("h1",{className:"da-form-h",children:"Welcome back"}),e.jsx("p",{className:"da-form-sub",style:{marginTop:8},children:"Sign in to your workspace. Your drafts, calendar, and learning loop are right where you left them."}),m&&e.jsxs("div",{className:"da-err",children:[e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",children:[e.jsx("circle",{cx:"7",cy:"7",r:"6",stroke:"currentColor"}),e.jsx("path",{d:"M7 4 V8 M7 10 V10.1",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round"})]}),m]}),e.jsxs("div",{className:"da-field-group",style:{marginTop:20},children:[e.jsxs("div",{className:"da-field",children:[e.jsx("label",{htmlFor:"li-email",children:"Email or username"}),e.jsx("div",{className:"da-input-wrap",children:e.jsx("input",{id:"li-email",type:"text",placeholder:"you@company.com",value:k,onChange:a=>V(a.target.value),autoComplete:"email"})})]}),e.jsxs("div",{className:"da-field",children:[e.jsx("label",{htmlFor:"li-password",children:"Password"}),e.jsxs("div",{className:"da-input-wrap has-icon",children:[e.jsx("input",{id:"li-password",type:M?"text":"password",placeholder:"••••••••••",value:N,onChange:a=>G(a.target.value),autoComplete:"current-password"}),e.jsx("button",{type:"button",className:"da-eye-btn",onClick:()=>H(a=>!a),children:e.jsx($,{open:M})})]})]}),e.jsxs("div",{className:"da-row-between",style:{marginTop:2},children:[e.jsxs("label",{className:"da-checkbox",children:[e.jsx("input",{type:"checkbox",checked:E,onChange:a=>R(a.target.checked)}),e.jsx("span",{className:"da-box",children:e.jsx("svg",{width:"10",height:"10",viewBox:"0 0 10 10",children:e.jsx("path",{d:"M2 5 L4 7 L8 3",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round",fill:"none"})})}),e.jsx("span",{children:"Keep me signed in"})]}),e.jsx("button",{type:"button",className:"da-link",style:{background:"none",border:"none",padding:0,cursor:"pointer"},onClick:()=>g("forgot"),children:"Forgot password?"})]}),e.jsx("button",{type:"submit",className:"da-submit",disabled:u,style:{marginTop:4},children:u?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"da-spinner"})," Signing in…"]}):e.jsxs(e.Fragment,{children:["Sign in ",e.jsx("span",{className:"da-arrow",children:"→"})]})})]}),P&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"da-divider",style:{marginTop:20},children:"or continue with"}),e.jsxs("div",{className:"da-oauth-row",style:{marginTop:12},children:[f.filter(a=>a.provider==="google").length>0&&e.jsxs("button",{type:"button",className:"da-oauth-btn",onClick:()=>y("google"),children:[e.jsxs("svg",{viewBox:"0 0 18 18",fill:"none",children:[e.jsx("path",{d:"M17.64 9.2c0-.64-.06-1.25-.16-1.84H9v3.49h4.84a4.14 4.14 0 0 1-1.8 2.72v2.26h2.91c1.7-1.57 2.69-3.88 2.69-6.63z",fill:"#4285F4"}),e.jsx("path",{d:"M9 18c2.43 0 4.47-.81 5.96-2.18l-2.91-2.26c-.81.54-1.84.86-3.05.86-2.34 0-4.32-1.58-5.03-3.71H.99v2.33A9 9 0 0 0 9 18z",fill:"#34A853"}),e.jsx("path",{d:"M3.97 10.71A5.41 5.41 0 0 1 3.68 9c0-.6.1-1.17.29-1.71V4.96H.99A9 9 0 0 0 0 9c0 1.45.35 2.83.99 4.04l2.98-2.33z",fill:"#FBBC05"}),e.jsx("path",{d:"M9 3.58c1.32 0 2.5.45 3.44 1.35l2.58-2.58A8.97 8.97 0 0 0 9 0 9 9 0 0 0 .99 4.96l2.98 2.33C4.68 5.16 6.66 3.58 9 3.58z",fill:"#EA4335"})]}),"Google"]}),f.filter(a=>a.provider==="github").length>0&&e.jsxs("button",{type:"button",className:"da-oauth-btn",onClick:()=>y("github"),children:[e.jsx("svg",{viewBox:"0 0 14 14",fill:"currentColor",children:e.jsx("path",{d:"M7 0a7 7 0 0 0-2.21 13.64c.35.06.48-.15.48-.34v-1.2c-1.95.42-2.36-.94-2.36-.94-.32-.81-.78-1.03-.78-1.03-.64-.43.05-.43.05-.43.7.05 1.07.72 1.07.72.62 1.07 1.64.76 2.04.58.06-.45.24-.76.44-.94-1.56-.18-3.2-.78-3.2-3.47 0-.77.27-1.4.72-1.89-.07-.18-.31-.9.07-1.88 0 0 .59-.19 1.93.72A6.7 6.7 0 0 1 7 3.36c.6 0 1.2.08 1.76.24 1.34-.91 1.93-.72 1.93-.72.38.98.14 1.7.07 1.88.45.49.71 1.12.71 1.89 0 2.7-1.65 3.29-3.22 3.46.25.22.48.65.48 1.32v1.96c0 .19.13.41.49.34A7 7 0 0 0 7 0z"})}),"GitHub"]}),_]})]}),e.jsxs("div",{className:"da-switch",style:{marginTop:20},children:["Don't have an account?"," ",e.jsx("button",{type:"button",onClick:()=>g("signup"),children:"Sign up"})]})]}),s==="forgot"&&e.jsxs("form",{className:"da-form-state",onSubmit:X,noValidate:!0,children:[e.jsx("button",{type:"button",className:"da-link",style:{background:"none",border:"none",padding:0,cursor:"pointer",marginBottom:16,fontSize:13},onClick:()=>g("login"),children:"← Back to sign in"}),e.jsx("h1",{className:"da-form-h",children:"Reset your password"}),e.jsx("p",{className:"da-form-sub",style:{marginTop:8},children:"Enter the email you registered with and we'll send you a reset link."}),m&&e.jsxs("div",{className:"da-err",style:{marginTop:16},children:[e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",children:[e.jsx("circle",{cx:"7",cy:"7",r:"6",stroke:"currentColor"}),e.jsx("path",{d:"M7 4 V8 M7 10 V10.1",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round"})]}),m]}),j&&e.jsx("div",{style:{marginTop:16,padding:"10px 14px",borderRadius:10,background:"#f0fdf4",border:"1px solid #bbf7d0",color:"#166534",fontSize:13,lineHeight:1.5},children:j}),!j&&e.jsxs("div",{className:"da-field-group",style:{marginTop:20},children:[e.jsxs("div",{className:"da-field",children:[e.jsx("label",{htmlFor:"fp-email",children:"Email address"}),e.jsx("div",{className:"da-input-wrap",children:e.jsx("input",{id:"fp-email",type:"email",placeholder:"you@company.com",value:w,onChange:a=>A(a.target.value),autoComplete:"email",autoFocus:!0})})]}),e.jsx("button",{type:"submit",className:"da-submit",disabled:u,style:{marginTop:4},children:u?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"da-spinner"})," Sending…"]}):e.jsxs(e.Fragment,{children:["Send reset link ",e.jsx("span",{className:"da-arrow",children:"→"})]})})]})]})]})]})]})]})}export{ue as default};
