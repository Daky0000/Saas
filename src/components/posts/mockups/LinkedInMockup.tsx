...
const LinkedInMockup = ({ caption, mediaUrls, linkMeta, linkLoading, linkError }: MockupProps) => {
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
      <div className="flex items-start gap-3">
        ...
        <div>
          <div className="text-sm font-semibold text-slate-900">Contentflow Team</div>
          <div className="text-xs text-slate-500">Marketing - 1h</div>
        </div>
      </div>
