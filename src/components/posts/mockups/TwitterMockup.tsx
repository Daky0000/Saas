...
const TwitterMockup = ({ caption, mediaUrls, linkMeta, linkLoading, linkError }: MockupProps) => {
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 text-sm font-semibold text-slate-900">
            Contentflow
            <span className="text-xs text-slate-500">@contentflow - 2m</span>
          </div>
          <div className="mt-2 whitespace-pre-wrap text-sm text-slate-800">{caption || 'Start typing to preview your post...'}</div>
