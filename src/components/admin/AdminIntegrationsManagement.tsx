...
const ALL_INTEGRATIONS: IntegrationDef[] = [
  ...
  },
  {
    ...
    isOAuth: true,
    fields: [
      { id: 'appId', label: 'App ID', placeholder: 'Meta App ID', type: 'text', helpText: 'Meta app identifier from developers.facebook.com.' },
      { id: 'appSecret', label: 'App secret', placeholder: 'Meta app secret', type: 'password', helpText: 'Keep secure — use the production secret when live.' },
      { id: 'redirectUri', label: 'Redirect URI', placeholder: 'https://yourdomain.com/auth/instagram/callback', type: 'url', helpText: 'Must match the callback URL in your Meta app settings.' },
    ],
  },
  {
    id: 'facebook',
    ...
    isOAuth: true,
    fields: [
      { id: 'appId', label: 'App ID', placeholder: 'Facebook App ID', type: 'text', helpText: 'Meta app ID tied to your Facebook page product.' },
      ...
      { id: 'redirectUri', label: 'Redirect URI', placeholder: 'https://yourdomain.com/auth/facebook/callback', type: 'url', helpText: 'Must match the redirect URI registered in your Facebook app.' },
    ],
  },
  {
    id: 'linkedin',
    ...
    fields: [
      ...
      { id: 'redirectUri', label: 'Redirect URI', placeholder: 'https://yourdomain.com/auth/linkedin/callback', type: 'url', helpText: 'Same callback URI configured inside LinkedIn.' },
    ],
  },
  {
    id: 'tiktok',
    ...
    fields: [
      ...
      { id: 'redirectUri', label: 'Redirect URI', placeholder: 'https://yourdomain.com/auth/tiktok/callback', type: 'url', helpText: 'Must match the URI registered in TikTok developer settings.' },
    ],
  },
  {
    id: 'twitter',
    ...
    isOAuth: true,
    fields: [
      { id: 'clientId', label: 'Client ID', placeholder: 'X OAuth 2 client ID', type: 'text', helpText: 'OAuth 2 client ID from your X developer app.' },
      { id: 'clientSecret', label: 'Client secret', placeholder: 'X client secret', type: 'password', helpText: 'Required for secure authorization code exchange.' },
      { id: 'redirectUri', label: 'Redirect URI', placeholder: 'https://yourdomain.com/auth/twitter/callback', type: 'url', helpText: 'This redirect URI must match your X developer setup.' },
    ],
  },
  {
    id: 'threads',
    ...
    isOAuth: true,
    fields: [
      { id: 'appId', label: 'App ID', placeholder: 'Meta App ID', type: 'text', helpText: 'Same Meta app that handles Instagram — enable Threads API in the app.' },
